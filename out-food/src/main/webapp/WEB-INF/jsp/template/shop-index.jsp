	...
	<div class="content content-box">
		<div class="store-box content clear-float">
			<div class="left-nav float-left">
				...
				<div class="shop-name">
					<label>卖&nbsp;&nbsp;&nbsp;&nbsp;家：</label>	<span>${shop.name}</span>
				</div>
				<div class="shop-service">
					<label>服务评分：</label><div class="service-star"><div id="ssb" class="service-star-bar" style="width:30%; max-width:100%;"></div></div> <span id="span1"></span>分
				</div>
				<div class="service-pinfe-list">
					<div>
						<label>服务态度：</label>
						<div class="service-star"><div id="ssb1" class="service-star-bar" style="width:60%; max-width:100%;"></div></div> <span id="span2"></span>分
					</div>
					<div>
						<label>发货速度：</label>
						<div class="service-star"><div id="ssb2" class="service-star-bar" style="width:20%; max-width:100%;"></div></div> <span id="span3"></span>分
					</div>
					<div>
						<label>商品质量：</label>
						<div class="service-star"><div id="ssb3" class="service-star-bar" style="width:20%; max-width:100%;"></div></div> <span id="span4"></span>分
					</div>
				</div>
				<div class="shop-info">
			...
			<div class="store-right float-right">
				...
				<div class="store-list">
					<h4>推荐产品
						<a href="${ctx}/item/getItemList.html?shopId=${shop.id}&byClassify=true" class="more">更多>></a>
					</h4>
						...
						<c:forEach items="${itemList}" var="item" varStatus="status" end="4">
							<c:if test="${status.index < 6}">
								<dl>
									...
									<dd class="name"><a href="${ctx}/item/getItemById.html?itemId=${item.id}">${fn:length(item.name)>21 ? fn:substring(item.name,0,21) : item.name}${fn:length(item.name)>21 ? '...' : ''}</a></dd>
									<dd class="price">
